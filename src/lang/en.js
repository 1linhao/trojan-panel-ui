export default {
  ...
  kernel: {
    manualOnly: 'Kernel upgrades are manual only. TP Core, Caddy and NaiveProxy are not upgraded here.',
    ...
    managedKernels: 'Managed kernels',
    ...
    inUse: 'In use',
    notInUse: 'Not in use',
    rollback: 'Rollback (last two)',
    upgrade: 'Upgrade',
    selected: 'Selected',
    createBatchTask: 'Create batch task',
    task: 'Upgrade task',
    taskHistory: 'Recent upgrade tasks',
    operator: 'Operator',
    viewTask: 'View',
    stage: 'Stage',
    error: 'Error',
    retryFailed: 'Retry failed items',
    prereleaseWarning: 'This target is an official prerelease and may be unstable. Continue?',
    prereleaseSecondWarning: 'Confirm again: deploy the prerelease to the selected node(s)?',
    mtlsNoFallback: 'The panel will probe mTLS first and switch only after success. It will never downgrade automatically.',
    mtlsEnabled: 'mTLS enabled',
    kernelSummary: 'Kernel summary',
    manage: 'Kernel management',
    tlsServerName: 'gRPC certificate name',
    tlsServerNamePlaceholder: 'For example: node.example.com',
    tlsServerNameRequired: 'Enter the DNS name on the node certificate',
    stages: {
      queued: 'Queued',
  ...
  table: {
    ...
    singBoxSubscribe: 'Copy sing-box Subscribe',
    ...
    xrayUotVersion: 'UoT Version',
    xrayUotHelp: 'Only for Shadowsocks 2022 servers and clients that support UoT',
    xrayXudpEnable: 'Enable XUDP',
    xrayMuxEnable: 'Enable Multiplex',
    ...
    hysteria2PortHopping: 'Port hopping',
    hysteria2HopInterval: 'Hop interval/seconds',
