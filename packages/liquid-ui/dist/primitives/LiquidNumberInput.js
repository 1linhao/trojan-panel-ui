...
const LiquidNumberInput = {
  ...
  data() {
    return { draft: this.value === null || this.value === void 0 ? "" : String(this.value) };
  },
  watch: {
    value(nextValue) {
      this.draft = nextValue === null || nextValue === void 0 ? "" : String(nextValue);
    }
  },
  computed: {
    numberOptions() {
  ...
  methods: {
    ...
    commit() {
      ...
      if (nextValue === void 0) {
        this.draft = this.value === null || this.value === void 0 ? "" : String(this.value);
